...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23) ; //WCRO
...
contract EarnCro is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Earn Cronos";
    string constant _symbol = "EARNCRO";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xcd7d16fB918511BF7269eC4f48d61D79Fb26f918;
    address RewardToken = 0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23; //WCRO
    ...
    constructor (address _marketingWallet, address _liquidityWallet) Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = _liquidityWallet;
